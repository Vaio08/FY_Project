...
@section('title',"Insurance Rules Create")
@section('breadcrumb')
    <li>
        <a class="parent-item" href="{{route('insuranceRule.index')}}">Insurance Rule</a>&nbsp;<i
            class="fa fa-angle-right"></i>
    </li>
    <li class="active">Insurance Rule Create</li>
@endsection
@section('content')
    <!-- start widget -->
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>Insurance Rule Create</header>
                ...
                <div class="card-body" id="bar-parent1">
                    <form action="{{route('insuranceRule.store')}}" method="POST" id="form_sample_1"
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" name="insuranceType">
                                        ...
                                        @foreach($insuranceTypes as $IT)
                                            <option value="{{$IT->id}}"> {{$IT->type_name}}
                                                ( {{ $IT->insuranceCategory->name }} )
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="value" data-required="1"
                                           class="form-control" value="{{old('value')}}" placeholder="Rule/Value"/>
                                </div>
                                @error('value')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
