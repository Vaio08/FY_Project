...
@section('title',"Health insurance Create")
@section('breadcrumb')
    <li>
    ...
    <li class="active">Health Insurance Create</li>
@endsection
@section('content')
    <!-- start widget -->
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="card card-box">
                <div class="card-head">
                    <header>Health Insurance Create</header>
                ...
                <div class="card-body" id="bar-parent1">
                    <form action="{{route('insuranceCreate.health')}}" method="POST" id="form_sample_1"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="number" min="0" max="24" name="mature_date" data-required="1"
                                ...
                                @if(session()->has('max_time_error'))
                                    <div class="text-danger">
                                        {{ session()->get('max_time_error') }}
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="phone" name="phone" data-required="1"
                                           class="form-control" value="{{ old('phone') }}" placeholder="Ex:01987654321"/>
                                </div>
                                @error('phone')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="occupation" data-required="1"
                                           class="form-control" value="{{ old('occupation') }}" placeholder="Software Engineer"/>
                                </div>
                                @error('occupation')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror

                                @if(session()->has('occupation_error'))
                                    <div class="text-danger">
                                        {{ session()->get('occupation_error') }}
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="address" data-required="1"
                                           class="form-control" value="{{ old('address') }}" placeholder="Software Engineer"/>
                                </div>
                                @error('address')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <select class="form-control" name="gender">
                                        ...
                                        <option @if(old('gender') == 'male')selected @endif value="1">Male</option>
                                        <option @if(old('gender') == 'female')selected @endif value="2">Female</option>
                                        <option @if(old('gender') == 'other')selected @endif value="3">Other</option>
                                    </select>
                                </div>
                                @error('gender')
                                <div class="text-danger">{{ $message }}</div>
