...
@section('title',"$insuranceCategory Insurance Deed P: $insurance->policy_no")
@section('breadcrumb')
    <li>
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <div id="capture-area">
                    <h3><b><img src="{{ asset('images/2268_t.png') }}" style="max-width: 70px;" alt="logo" class="logo-default"/> Insurance
                            Company</b></h3>
                    <h4 class="text-center">{{ $insuranceCategory }} Insurance Deed</h4>
                    <hr>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    @elseif($insuranceCategory == 'Car')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <b>Vehicle Model:</b> {{ $insuranceDetails->vehicle_model }}
                            </div>
                            <div class="col-md-6">
                                <b>Year:</b> {{ $insuranceDetails->year }}
                            </div>

                            <div class="col-md-6">
                                <b>Licence Number:</b> {{ $insuranceDetails->licence_number }}
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p>
                                The information that I have provided are all true which are authorized with documents
